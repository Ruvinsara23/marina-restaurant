...
const Homepage = () => {
  return (
   ...
   <motion.img className="box hero-img"
   ...
   <h1 >Our Best Selling <span className="colored-word"> Products</span></h1>
      <Bestselling />
    </div>
    <div className='best-selling-product-container'>
    ...
    <div className="best-selling-product-container">
   <h1 >What people are saying  <span className="colored-word"> about us </span></h1>
      <Feedback />
    </div>
    <div className="best-selling-product-container">
   <h1 >Experience Our Convenient   <span className="colored-word"> Features</span></h1>
      <Features />
    </div>
